...
# Grouped results
small.df<-data.frame(x=x,
                     proportion = c(p[1,],p[2,],p[3,]),
                     N = c(rep("25",tr),rep("50",tr),rep("75",tr)))
small.df$ub <- pmin(1,
     small.df$proportion+
       qnorm(0.975)*sqrt(small.df$proportion*(1-small.df$proportion)/n))
...
# Plot of proportions
plot_proportion_small<- ggplot() + theme_classic() +
  geom_line(data = small.df, aes(x = x, y = proportion, col = N), linewidth = 1) + 
  #geom_xspline(data=small.df, aes(x=x,y = proportion,col=N),
  #             spline_shape=2, size=1)+
  xlab(expression(theta[2])) +  ylab("Correct Classification Rate") +
  geom_ribbon(data=small.df,aes(x=x,ymin=lb,ymax = ub,
...
cairo_pdf("gwespsmallproportion5000.pdf",width=8, height=8)
plot_proportion_small
dev.off()
...
#  geom_xspline(data=small.df, aes(x=x,y = propensity, col=size),
#               spline_shape=1, size=0.9) +  scale_color_manual(values=colors) +
#  xlab(expression(theta[2])) + ylab("Median propensity") + 
#  geom_ribbon(data=small.df,aes(x=x,ymin=lb,ymax=ub,col=size),alpha=.15) +
...
#   geom_xspline(data=small.df2, aes(x=x,y = proportion100),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb100.2,ymax=ub100.2),alpha=.15) +
...
#   geom_xspline(data=small.df2, aes(x=x,y = proportion200),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb200.2,ymax=ub200.2),alpha=.15) +
#   scale_x_continuous(limits = c(0, 0.1)) + geom_hline(yintercept=1) +
#   theme(axis.title.y.left = element_text(size = 14),
#         axis.title.x.bottom = element_text(size = 14),
#         axis.text = element_text(size = 11),
...
#   geom_xspline(data=small.df2, aes(x=x,y = proportion300),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb300.2,ymax=ub300.2),alpha=.15) +
#   scale_x_continuous(limits = c(0, 0.1)) + geom_hline(yintercept=1) +
#   theme(axis.title.y.left = element_text(size = 14),
#         axis.title.x.bottom = element_text(size = 14),
#         axis.text = element_text(size = 11),
...
#   geom_xspline(data=small.df2, aes(x=x,y = propensity100),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb100,ymax=ub100),alpha=.15) +
#   scale_x_continuous(limits = c(0, 0.1)) + geom_hline(yintercept=1) +
#   theme(axis.title.y.left = element_text(size = 14),
#         axis.title.x.bottom = element_text(size = 14),
#         axis.text = element_text(size = 11),
...
#   geom_xspline(data=small.df2, aes(x=x,y = propensity200),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb200,ymax=ub200),alpha=.15) +
#   scale_x_continuous(limits = c(0, 0.1)) + geom_hline(yintercept=1) +
#   theme(axis.title.y.left = element_text(size = 14),
#         axis.title.x.bottom = element_text(size = 14),
#         axis.text = element_text(size = 11),
...
#   geom_xspline(data=small.df2, aes(x=x,y = propensity300),
#                spline_shape=1, size=0.9, col="blue")+
#   xlab(expression(theta[2])) + ylab("Correct classification rate") +
#   geom_ribbon(data=small.df2,aes(x=x,ymin=lb300,ymax=ub300),alpha=.15) +
#   scale_x_continuous(limits = c(0, 0.1)) + geom_hline(yintercept=1) +
#   theme(axis.title.y.left = element_text(size = 14),
#         axis.title.x.bottom = element_text(size = 14),
#         axis.text = element_text(size = 11),
